...
function getDefaultRecommendations(record: any) {
  ...
  const plans: Record<string, any> = {
    A: { shortTerm: '巩固核心知识点，尝试挑战更高难度的题�?, mediumTerm: '深入学习进阶内容，参与项目实�?, longTerm: '准备参加相关竞赛，向培优方向发展' },
    B: { shortTerm: '查漏补缺，重点复习薄弱知识点', mediumTerm: '系统学习进阶内容，加强练�?, longTerm: '力争达到优秀水平，挑战竞赛内�? },
    C: { shortTerm: '夯实基础知识，多做基础练习�?, mediumTerm: '逐步提升难度，建立知识体�?, longTerm: '达到良好水平，向进阶内容迈进' },
    D: { shortTerm: '从零开始系统学习基础知识', mediumTerm: '加强基础练习，培养学习兴�?, longTerm: '稳步提升，争取达到合格水�? },
  };
  const classRecs: Record<string, Record<string, any>> = {
    aigc: {
      A: { className: 'AIGC进阶�?, reason: '您的AIGC素养测评成绩优秀，建议直接报读进阶班�?, path: ['AIGC入门', 'AIGC基础', 'AIGC进阶', 'AIGC培优'] },
      B: { className: 'AIGC进阶�?, reason: '您的AIGC素养测评成绩良好，建议报读进阶班�?, path: ['AIGC入门', 'AIGC基础', 'AIGC进阶', 'AIGC培优'] },
      C: { className: 'AIGC入门�?, reason: '建议从AIGC入门班开始，系统学习AI基础知识�?, path: ['AIGC入门', 'AIGC基础', 'AIGC进阶', 'AIGC培优'] },
      D: { className: 'AIGC入门�?, reason: '建议从AIGC入门班开始，培养AI素养�?, path: ['AIGC入门', 'AIGC基础', 'AIGC进阶', 'AIGC培优'] },
    },
    python: {
      A: { className: 'Python/C++进阶�?, reason: '您的编程基础扎实，建议报读进阶班�?, path: ['Scratch入门', 'Python基础', 'Python进阶', 'C++培优'] },
      B: { className: 'Python基础�?, reason: '您具备一定编程基础，建议系统学习Python�?, path: ['Scratch入门', 'Python基础', 'Python进阶', 'C++培优'] },
      C: { className: 'Scratch入门�?, reason: '建议从Scratch开始，培养编程兴趣�?, path: ['Scratch入门', 'Python基础', 'Python进阶', 'C++培优'] },
      D: { className: 'Scratch入门�?, reason: '建议从Scratch图形化编程开始�?, path: ['Scratch入门', 'Python基础', 'Python进阶', 'C++培优'] },
    },
    cpp: {
      A: { className: 'C++算法进阶�?, reason: '您的数理逻辑能力出色，非常适合学习C++算法�?, path: ['C++入门', 'C++基础', '算法进阶', '竞赛培优'] },
      B: { className: 'C++算法进阶�?, reason: '您的数理逻辑能力良好，适合学习C++算法�?, path: ['C++入门', 'C++基础', '算法进阶', '竞赛培优'] },
      C: { className: 'Python编程入门�?, reason: '建议先学习Python编程，再过渡到C++算法�?, path: ['Python入门', 'Python进阶', 'C++基础', '算法进阶'] },
      D: { className: 'Scratch入门�?, reason: '建议从Scratch图形化编程开始，培养编程兴趣�?, path: ['Scratch入门', 'Python基础', 'C++基础', '算法进阶'] },
    },
    scratch: {
      A: { className: 'Scratch进阶�?, reason: '您的图形化编程基础扎实，建议继续学习进阶内容�?, path: ['Scratch入门', 'Scratch进阶', 'Python基础', 'Python进阶'] },
      B: { className: 'Scratch进阶�?, reason: '您的图形化编程基础良好，建议学习进阶内容�?, path: ['Scratch入门', 'Scratch进阶', 'Python基础', 'Python进阶'] },
      C: { className: 'Scratch入门�?, reason: '建议从Scratch入门班开始，培养编程兴趣�?, path: ['Scratch入门', 'Scratch进阶', 'Python基础', 'Python进阶'] },
      D: { className: 'Scratch入门�?, reason: '建议从Scratch图形化编程开始，培养编程兴趣�?, path: ['Scratch入门', 'Scratch进阶', 'Python基础', 'Python进阶'] },
    },
    math: {
      A: { className: 'Python编程进阶�?, reason: '您的数理逻辑能力出色，具备良好的逻辑思维基础，建议直接学习Python编程进阶内容�?, path: ['数理启蒙', 'Python基础', 'Python进阶', '算法竞赛'] },
      B: { className: 'Python编程基础�?, reason: '您的数理逻辑能力良好，适合学习Python编程，快速进入代码编程世界�?, path: ['数理启蒙', 'Python基础', 'Python进阶', '算法竞赛'] },
      C: { className: 'Scratch入门�?, reason: '建议从Scratch图形化编程开始，通过积木式编程培养编程兴趣和逻辑思维能力�?, path: ['Scratch入门', 'Scratch进阶', 'Python基础', 'Python进阶'] },
      D: { className: 'Scratch入门�?, reason: '建议从Scratch图形化编程开始，逐步建立编程思维，为后续学习打下基础�?, path: ['Scratch入门', 'Scratch进阶', 'Python基础', 'Python进阶'] },
    },
  };
  return {
...
export default function ReportDetail({ record, onClose, showShareActions = false }: ReportDetailProps) {
  ...
  const dimensionLabels: Record<string, { short: string; full: string; desc: string; category: string }> = {
    COG_UNDERSTANDING: { short: '问题理解', full: '问题理解与分�?, desc: '理解问题、分解任务、识别关键信息的能力', category: 'cognitive' },
    COG_REASONING: { short: '逻辑推理', full: '逻辑推理与判�?, desc: '逻辑推理、条件判断、因果分析的能力', category: 'cognitive' },
    COG_TRANSFER: { short: '知识迁移', full: '知识迁移与应�?, desc: '已有知识在新场景中的应用能力', category: 'cognitive' },
    SKL_BASIC: { short: '基础操作', full: '基础操作与工具使�?, desc: '基本操作、工具使用的熟练程度', category: 'skill' },
    SKL_APPLICATION: { short: '进阶应用', full: '进阶应用与问题解�?, desc: '综合运用知识解决实际问题的能�?, category: 'skill' },
    SKL_EFFICIENCY: { short: '效率质量', full: '效率与质量控�?, desc: '完成任务的速度和质量控制能�?, category: 'skill' },
    QLT_ATTENTION: { short: '专注细心', full: '专注力与细心�?, desc: '审题仔细、计算准确、细节关注程�?, category: 'quality' },
    QLT_EXPRESSION: { short: '创意表达', full: '创意与表达能�?, desc: '创意构思、思路表达、分享交流能�?, category: 'quality' },
    QLT_ATTITUDE: { short: '学习态度', full: '学习态度与成长潜�?, desc: '学习积极性、尝试意愿、成长空�?, category: 'quality' },
    INN_CREATIVITY: { short: '创新意识', full: '创新意识与创造力', desc: '发散思维、创新方案设计能�?, category: 'innovation' },
    INN_EXPLORATION: { short: '探索精神', full: '探索精神与好奇心', desc: '主动探索、问题发现、持续追问能�?, category: 'innovation' },
    INN_DESIGN: { short: '设计思维', full: '设计思维与迭代优�?, desc: '方案设计、测试改进、迭代优化能�?, category: 'innovation' },
    COL_EXPRESSION: { short: '表达沟�?, full: '表达与沟通能�?, desc: '清晰表达、有效沟通、观点分享能�?, category: 'collaboration' },
    COL_TEAMWORK: { short: '团队协作', full: '团队协作能力', desc: '分工合作、协调配合、共同目标达成能�?, category: 'collaboration' },
    COL_SHARING: { short: '知识分享', full: '知识分享与互�?, desc: '帮助他人、经验分享、互助学习能�?, category: 'collaboration' },
    ETH_AWARENESS: { short: '伦理意识', full: 'AI伦理意识', desc: '了解AI伦理问题、识别伦理风险能�?, category: 'ethics' },
    ETH_RESPONSIBILITY: { short: '数字责任', full: '数字责任与安全意�?, desc: '数据安全、隐私保护、负责任使用AI能力', category: 'ethics' },
    ETH_HUMANISTIC: { short: '人文素养', full: '人文素养与价值判�?, desc: '以人为本、价值判断、科技向善能力', category: 'ethics' },
  };

  // 6大维度分类映�?  const categoryLabels: Record<string, { name: string; codes: string[] }> = {
    cognitive: { name: '认知能力', codes: ['COG_UNDERSTANDING', 'COG_REASONING', 'COG_TRANSFER'] },
    skill: { name: '技能能�?, codes: ['SKL_BASIC', 'SKL_APPLICATION', 'SKL_EFFICIENCY'] },
    ...
    collaboration: { name: '协作沟�?, codes: ['COL_EXPRESSION', 'COL_TEAMWORK', 'COL_SHARING'] },
    ethics: { name: 'AI伦理', codes: ['ETH_AWARENESS', 'ETH_RESPONSIBILITY', 'ETH_HUMANISTIC'] },
  };

  // 维度雷达图数�?- 固定6大维度展�?  const getDimensionRadarData = () => {
    ...
    // 第一步：�?dimensionScores�?8小维度数据）�?category 聚合
    ...
    // 第二步：如果某category没有数据，从answers中按dimension_code推断并计�?    const missingCategories = Object.entries(categories)
    ...
    // 第三步：如果仍有category没有数据，使用该category下所有题目答题正确率的平均�?    const stillMissing = Object.entries(categories)
      .filter(([_, v]) => v.count === 0)
      .map(([k]) => k);
    ...
    // 第四步：如果仍有category没有数据，使用总分作为默认�?    const finalMissing = Object.entries(categories)
      .filter(([_, v]) => v.count === 0)
      .map(([k]) => k);
    ...
    const labels = ['认知能力', '技能能�?, '综合素养', '创新思维', '协作沟�?, 'AI伦理'];
    const data = [
  ...
  // 历史趋势图数�?  const getGrowthTrendData = () => {
    const sortedHistory = [...growthHistory].sort((a, b) =>
      new Date(a.created_at || '').getTime() - new Date(b.created_at || '').getTime()
    );

    // 安全解析scores：处理对象、JSON字符串、null等各种情�?    const parseScores = (scores: any): Record<string, number> => {
    ...
    return {
      labels: sortedHistory.map((h, i) => `�?{i + 1}次`),
      datasets: [
        {
          label: '认知能力',
  ...
  const getRecommendations = useCallback((rec: any) => {
    if (rec?.recommendations) {
      try {
        ...
        // 确保解析后的对象包含必要的字�?        if (parsed && (parsed.learningPlan || parsed.aiAnalysis || parsed.classRecommendation)) {
          return parsed;
        }
      } catch { /* 解析失败，使用默认�?*/ }
    }
  ...
  const barData = {
    labels: knowledgePoints,
    datasets: [
      { label: '正确�?, data: knowledgePoints.map((k) => stats[k].correct), backgroundColor: '#22c55e', borderRadius: 8 },
      { label: '错误�?, data: knowledgePoints.map((k) => stats[k].total - stats[k].correct), backgroundColor: '#ef4444', borderRadius: 8 },
    ],
  };
      ...
      try {
        if (record.answers) {
          ...
          answerDetails = answers.map((ans: any) => ({
            ...
            knowledgePoint: ans.knowledgePoint || ans.knowledge_point || '知识�?,
            studentAnswer: ans.studentAnswer || ans.student_answer || '未作�?,
  ...
  // AI降级方案：当AI分析不可用时，基于规则生成分析内�?  const getFallbackAIAnalysis = useCallback(() => {
    const level = record.level;
    ...
    return {
      knowledgeAnalysis: `根据测评结果，学生在${Object.keys(stats).join('�?) || '多个'}知识点上进行了测试。整体掌握程度为${level}级（${level === 'A' ? '优秀' : level === 'B' ? '良好' : level === 'C' ? '合格' : '待提�?}），总正确率�?{record.score || 0}%。`,
      logicAbility: `逻辑思维能力${level === 'A' ? '出色，展现出优秀的分析和推理能力' : level === 'B' ? '良好，具备较好的逻辑思考能�? : level === 'C' ? '合格，逻辑思维有提升空�? : '有待提升，建议加强基础逻辑训练'}。`,
      potential: `学生展现�?{level === 'A' || level === 'B' ? '较好的学习潜力，能够快速理解和应用新知�? : '一定的学习潜力，通过系统训练可以显著提升'}。`,
      ...
      development: `建议${level === 'D' ? '从基础开始系统学习，建立扎实的知识体�? : level === 'C' ? '加强练习巩固基础，逐步提升难度' : level === 'B' ? '挑战更高难度内容，拓展知识广�? : '深入学习进阶内容，参与竞赛和项目实践'}。`,
    };
  ...
  const analysisDimensions = [
    { key: 'knowledgeAnalysis', icon: BookMarked, title: '知识掌握度分�?, color: 'bg-blue-500', lightColor: 'bg-blue-50', textColor: 'text-blue-700' },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="glass-card rounded-3xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-slate-800">能力维度雷达�?/h3>
              <button
          ...
          <div className="glass-card rounded-3xl p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-slate-800">成长趋势�?/h3>
            </div>
        ...
        <div className="glass-card rounded-3xl p-6">
          ...
          {displayAiAnalysis ? (
            ...
            <div className="p-4 bg-slate-50 rounded-2xl text-center">
              <p className="text-sm text-slate-500">AI分析数据加载中，请稍后刷新查�?..</p>
            </div>
          )}
        </div>
        ...
        {recommendations?.learningPlan && (
          <div className="glass-card rounded-3xl p-6">
            ...
            <div className="space-y-4">
              {[
                { icon: <Clock size={14} />, title: '短期目标�?个月�?, text: recommendations.learningPlan.shortTerm, color: 'bg-emerald-500' },
                { icon: <Calendar size={14} />, title: '中期目标�?个月�?, text: recommendations.learningPlan.mediumTerm, color: 'bg-blue-500' },
                { icon: <Star size={14} />, title: '长期目标�?学期�?, text: recommendations.learningPlan.longTerm, color: 'bg-purple-500' },
              ].map((item, idx) => (
            ...
            {JSON.parse(record.answers || '[]').map((ans: any, idx: number) => (
              <div key={idx} className={`flex items-center gap-4 p-4 rounded-2xl ${ans.isCorrect ? 'bg-emerald-50 border border-emerald-200' : 'bg-red-50 border border-red-200'}`}>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-slate-700">{ans.knowledgePoint || '知识�?}</p>
                  <p className="text-xs text-slate-500 mt-1">您的答案：{ans.studentAnswer || '未作�?} | 正确答案：{ans.correctAnswer}</p>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" onClick={() => setShowDimensionHelp(false)}>
          <div className="bg-white rounded-3xl p-6 max-w-lg w-full max-h-[80vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              ...
              {/* 技能能�?*/}
              <div>
                <h4 className="text-sm font-bold text-emerald-700 mb-2">技能能�?/h4>
                <div className="space-y-2">
              ...
              {/* 协作沟�?*/}
              <div>
                <h4 className="text-sm font-bold text-pink-700 mb-2">协作沟�?/h4>
                <div className="space-y-2">
              ...
              {/* AI伦理与责�?*/}
              <div>
                <h4 className="text-sm font-bold text-teal-700 mb-2">AI伦理与责�?/h4>
                <div className="space-y-2">
