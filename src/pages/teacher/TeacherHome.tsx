...
import { classApi, studentApi, examApi } from '../../api-client/client';
...
export default function TeacherHome() {
  ...
  const statCards = [
    ...
    { title: '已测�?, value: stats.examCompleted, icon: <ClipboardCheck size={24} />, color: 'bg-emerald-500', path: '/teacher/class' },
    { title: '待测�?, value: stats.examPending, icon: <TrendingUp size={24} />, color: 'bg-amber-500', path: '/teacher/class' },
    { title: '班级�?, value: stats.totalClasses, icon: <GraduationCap size={24} />, color: 'bg-purple-500', path: '/teacher/class' },
  ];
  ...
  return (
    <div className="space-y-6 fade-in">
      <div className="glass-card rounded-3xl p-6">
        <h1 className="text-xl font-bold text-slate-800">教师工作�?/h1>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">批量导入或单个添加学生信�?/p>
              </div>
            </button>
            <button
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">配置模板并发送录取通知�?/p>
              </div>
            </button>
            <button
